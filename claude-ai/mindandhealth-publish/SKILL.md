...
5. Bajo petición y si Pablo aporta los títulos o el texto de artículos previos: **propuestas de enlaces internos** entre artículos del vault.
...
## Invocación (lenguaje natural)

"pensemos sobre X", "me ronda esta idea", "¿qué opinas de…?", "ayúdame a pulir este borrador", "saca canvas con lo que llevamos", "haz la newsletter del último artículo", "dame el prompt de imagen para este post".
